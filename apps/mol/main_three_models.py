        ...
        if done:  # end of episode
            ...
            if model_update:
                if episodes != 0 and episodes % frequency == 0:
                    ...
                    if column == "HOMO_LUMO":
                        environment.model1 = multiple_train(environment.model1,
                                                            X_train_1, y_train_1, X_valtest_1, y_valtest_1)
                        environment.model2 = multiple_train(environment.model2,
                                                            X_train_2, y_train_2, X_valtest_2, y_valtest_2)
                        environment.model3 = multiple_train(environment.model3,
                                                            X_train_3, y_train_3, X_valtest_3, y_valtest_3)
                    else:
                        environment.model1 = train(environment.model1, X_train_1, y_train_1, X_valtest_1, y_valtest_1)
                        environment.model2 = train(environment.model2, X_train_2, y_train_2, X_valtest_2, y_valtest_2)
                        environment.model3 = train(environment.model3, X_train_3, y_train_3, X_valtest_3, y_valtest_3)
